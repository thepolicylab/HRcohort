...
```{r}
#grid_tracker_link = 'https://docs.google.com/spreadsheets/d/12NiUpu28SOCQvQTrp17b592cMgOoCgel#MQyE1PNZygU/edit?usp=sharing'
grid_tracker_link = 'https://drive.google.com/file/d/1OIXl72BpQg7RXocMOTLbqQVifbH571dn/view?usp=sharing'
file_id = drive_get(as_id(grid_tracker_link))

grid_tracker_dir = glue("{getwd()}/grid_tracker.xlsx")
...
grid_tracker_df = readxl::read_excel(grid_tracker_dir) %>% 
  select(-c("State"))
```
...
```{r}
#share_link = 'https://drive.google.com/drive/folders/1zoeLvd5flvvKFNMSmoRxYhE_LK_-19N5?usp=sh#aring'
share_link = 'https://drive.google.com/drive/folders/1miOrgG2nVgkFKtpaBeOwhEYeqaFMJFIy?usp=sharing'
...
```{r}
hr_ds_link = "https://drive.google.com/drive/folders/1rGy7qHWjIoqZSaUDh0EO3u_FX7y2N9W-?usp=sharing"
...
```{r}
drive_upload(OUTPUT_DIR, as_id(hr_ds_id$id), name = "total_hrcohort.csv.gz", overwrite = TRUE, verbose = TRUE)
```
